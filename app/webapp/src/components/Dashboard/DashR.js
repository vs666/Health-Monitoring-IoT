  ...
  render() {
    return (
      <div style={{ paddingTop: '3vh', paddingRight: '2vh' }}>
        <p className="top-tag" style={{ textAlign: 'right' }}>
          {this.state.username}
        </p>
        <div>
          <Jumbotron
          ...
          >
            ...
            <p>
              <Link to="/editDetails" style={{ color: '#055' }}>
                Edit Details
              </Link>
            </p>
          </Jumbotron>
        ...
        <Tabs defaultActiveKey="details" id="uncontrolled-tab-example">
          <Tab class="tabcus" eventKey="details" title="Details">
            ...
            >
              ...
              <a href={this.state.details['resumeLink']}>Resume</a>{' '}
              {/*implement this part */}
              {/* Code for image here */}
            </div>
          </Tab>
            ...
            <Container>
              <Jumbotron
                style={{
                  ...
                  marginRight: '5vh',
                  color: '#055',
                  backgroundColor: 'rgba(110,200,200,0.2)',
                }}
              >
                <p
                  style={{
                ...
                <Form inline onSubmit={this.searchField}>
                  ...
                  >
                    ...
                    <Dropdown.Item>
                      <Button
                        ...
                        size="lg"
                        onClick={() => {
                          this.setState({ jobtype: 'Part-Time' })
                        }}
                      >
                        Part-Time
                      </Button>
                    ...
                    <Dropdown.Item>
                      <Button
                        ...
                        size="lg"
                        onClick={() => {
                          this.setState({ jobtype: 'WorkFromHome' })
                        }}
                      >
                        WorkFromHome
                      </Button>
                    ...
                    <Dropdown.Item>
                      <Button
                        ...
                        size="lg"
                        onClick={() => {
                          this.setState({ jobtype: 'All Types' })
                        }}
                      >
                        Any Type
                      </Button>
                  ...
                  <InputGroup className="mb-3">
                    ...
                    <FormControl
                      ...
                      value={this.state.salaryUl}
                      onChange={(event) => {
                        this.setState({ salaryUl: event.target.value })
                      }}
                    />
                    <FormControl
                      type="text"
                      placeholder="Min Salary"
                      value={this.state.salaryLl}
                      onChange={(event) => {
                        this.setState({ salaryUl: event.target.value })
                      }}
                    />
                    <Button
                      style={{ marginLeft: '2vh', paddingLeft: '2vh' }}
                      variant="success"
                      type="submit"
                    >
                      GO
                ...
                <div style={{ paddingTop: '3%' }}>
                  ...
                  >
                    ...
                    <tbody>{Parser(this.state.table)}</tbody>
                  </Table>
                </div>
              </Jumbotron>
            </Container>
          ...
          <Tab class="tabcus" eventKey="contact" title="My Applications">
            <Jumbotron style={{ backgroundColor: 'rgba(0,0,0,0.3' }}>
              <p>My Applications</p>
              <Button type="success" onClick={this.updateTable}>
                Reload
              </Button>
              <div style={{ paddingTop: '3%' }}>
                <Table
